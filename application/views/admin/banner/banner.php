...
<div class="row">
    <div class="col-lg-4 col-md-12">
        <div class="box box-primary">
            ...
            <!-- form start -->
            <?php echo form_open_multipart('banner/add_banner_image_post'); ?>
                            ...
                            <table class="table table-bordered table-striped dataTable" id="cs_datatable_lang" role="grid"
                                ...
                                <?php foreach ($images as $item): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <!--Form-->
                                            <?php echo form_open('banner/delete_banner_image_post'); ?>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="<?php echo base_url(); ?>banner/update_banner_image/<?php echo html_escape($item->id); ?>"><i
