                ...
                <div class="tab-pane active" id="tab_1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                                <input type="radio" name="multilingual_system" value="1" id="multilingual_system_1"
                                       class="flat-red" <?php echo ($general_settings->multilingual_system == 1) ? 'checked' : ''; ?>>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                                <input type="radio" name="registration_system" value="1" id="registration_system_1"
                                       class="flat-red" <?php echo ($general_settings->registration_system == 1) ? 'checked' : ''; ?>>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                                <input type="radio" name="comment_system" value="1" id="comment_system_1"
                                       class="flat-red" <?php echo ($general_settings->comment_system == 1) ? 'checked' : ''; ?>>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                                <input type="radio" name="slider_active" value="1" id="slider_active_1"
                                       class="flat-red" <?php echo ($general_settings->slider_active == 1) ? 'checked' : ''; ?>>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                                <input type="radio" id="emoji_reactions_1" name="emoji_reactions" value="1" class="flat-red" checked>&nbsp;&nbsp;
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                                <input type="radio" id="emoji_reactions_2" name="emoji_reactions" value="0" class="flat-red" <?php echo ($general_settings->emoji_reactions != "1") ? 'checked' : ''; ?>>&nbsp;&nbsp;
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                                <input type="radio" name="show_pageviews" value="1" id="show_pageviews_1"
                                       class="flat-red" <?php echo ($general_settings->show_pageviews == 1) ? 'checked' : ''; ?>>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                                <input type="radio" name="show_rss" value="1" id="show_rss_1"
                                       class="flat-red" <?php echo ($general_settings->show_rss == 1) ? 'checked' : ''; ?>>
                        ...
                        <div class="col-sm-12">
                            <div class="row">
                                ...
                                <div class="custom-checkbox">
                                    ...
                                    <label for="color8" style=" background-color: #182333;"></label>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <?php if (!empty($general_settings->logo_path)): ?>
                                        <img src="<?php echo base_url() . html_escape($general_settings->logo_path); ?>" alt="" style="max-width: 200px;">
                                    <?php endif; ?>
                                </div>
                            </div>
                ...
                <div class="tab-pane" id="tab_3">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="ckEditor" class="form-control" name="contact_text"
                                  placeholder="<?php echo trans('contact_text'); ?>"><?php echo html_escape($form_settings->contact_text); ?></textarea>
                    </div>
                ...
                <div class="tab-pane" id="tab_4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"
                               ...
                               value="<?php echo html_escape($form_settings->google_url); ?>">
                    </div>
