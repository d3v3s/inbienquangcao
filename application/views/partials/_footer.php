				...
				<div class="col-xs-12 col-sm-6 col-md-3 widget">
					...
					<nav>
						...
						<div class="footer-count">
							<p class="count-number" data-count="3550">Tất cả dự án :
								<span class="counter"></span></p>
						</div>
						<div class="footer-count">
							<p class="count-number" data-count="2550">Khách hàng thân thiết :
								<span class="counter"></span></p>
						</div>
					</nav>
				</div>
...
<div id="arcontactus" class="arcontactus-widget arcontactus-message left lg active">
	...
	<div class="arcontactus-message-button" style="background-color: #008749">
		...
		<div class="icons">
			<div class="icons-line" style="transform: translate(-194px, 0px);">
...
<script type="text/javascript">
    ...
    window.addEventListener('load', function(){
        ...
        arcItem.href = 'https://zalo.me/0948998383';
