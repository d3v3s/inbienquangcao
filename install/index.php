...
if (isset($_POST["btn_license_code"])) {
    ...
    $url = "http://license.codingest.com/api/check_infinite_license_code?license_code=" . $_POST['license_code'] . "&domain=" . $current_url;
    ...
    if (empty($response)) {
        $url = "https://license.codingest.com/api/check_infinite_license_code?license_code=" . $_POST['license_code'] . "&domain=" . $current_url;
                                    ...
                                    <div class="tab-content">
                                        <div class="tab_1">
                                            ...
                                            <div class="form-group text-center">
                                                <a href="#" target="_blank" class="btn btn-success btn-custom">NULLED - ENJOY!</a>
                                            </div>
                                        </div>
                                    </div>
