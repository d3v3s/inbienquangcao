                    ...
                    <div class="install-box">
                        ...
                        <div class="step-contents">
                            <div class="tab-1">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <p><i class="fa fa-folder-open"></i> application/config/routes_lang.php</p>
                                    ...
                                    <div class="col-sm-6 text-right">
                                        <p><?php if (is_writable('../application/config/routes_lang.php')) { ?><i class="fa fa-check text-success"></i><?php } else { ?><i class="fa fa-close text-danger"></i><?php } ?></p>
