...
if (isset($_POST["btn_admin"])) {
    ...
    if (mysqli_connect_errno()) {
        ...
        mysqli_query($connection, "INSERT INTO users (id, username, slug, email, 	password, role, status) VALUES (1, '" . $_POST["admin_username"] . "', '" . $slug . "', '" . $_POST["admin_email"] . "','" . $password . "','admin', 1)");
        mysqli_query($connection, "UPDATE general_settings SET inf_key='" . $_SESSION["license_code"] . "', purchase_code='" . $_SESSION["purchase_code"] . "' WHERE id='1'");
